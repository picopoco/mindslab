...
class testDA(provider_pb2.DialogAgentProviderServicer):
    ...
    provider.description = 'word_pronunciation'
    ...
    is_external = False
    stat = {}
    model_list = ['word_pronunciation1','word_pronunciation2','word_pronunciation3','word_pronunciation4','word_pronunciation5']
    ...
    def GetRuntimeParameters(self, empty, context):
        ...
        sds_path.default_value = 'word_pronunciation'
	...
	if talk.text.find('word_pronunciation') == 0:
	    local_stat.c_model = str(talk.text[-1])

        dp.model = 'word_pronunciation' + local_stat.c_model
	...
	talk_res = provider_pb2.TalkResponse()
       ...
       # obj['Dialog_turn'] = local_stat.c_model
        ...
        local_stat.c_da_obj['feedback'] = ran.choice(['Excellent','Good','Not Bad'])      
        local_stat.c_da_obj['totalAvgScore'] = 70 +ran.randrange(5,30) 
        ...
        logging.debug('####c_da_obj: %s',result) 
    ...
    def Close(self, req, context):
        logging.debug( 'Closing for %s ', req.session_id, req.agent_key)
